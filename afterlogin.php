		...
		<div id="main" style="width:78%;float:left;" >
			...
			<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				...
				<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
					...
					<span id="span2" style="margin-left:20px;">Department</span>
					<input type="text" name="subcategory" style="width:30%;border-radius:5px;height:37px; border:.8px solid aqua;" placeholder="Please Enter your department..">
					<br /><br />
					<span id="span2">Subject of Complaint</span><input type="text" name="nature" class="form-control in2" placeholder="Regarding to ...."><br />
					<span id="span">Complaint</span>
					<textarea name="comp" class="form-control in1" placeholder="Write your complaint in detail. Feel free to write." style="height:200px;"></textarea><br />
								...
								{				
										...
										if($id==$inid)
										{
											...
											echo "<a href='$fil' target='_blank'>view file</a><br />";
											 ...
											 Complaint-Department:   <span id='span'>$subcate</span><br>
											 Complaint-Subject:        <span id='span'>$nat</span><br />
