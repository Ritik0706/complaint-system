	...
	<body>
		<nav class="navbar-nav navbar-expand-sm bg-info" style="margin:0px;padding:0px;">
			...
			<img src="Admin1.png" style="border-radius:15%;margin-left:25%;float:left" width="70px" height="80px">
					<h3  style="float:left;cursor:pointer;margin:10px 2px 0px 20px;">CMS | Admin</h3>
		...
		<h2 style="padding-top:10px;">Complete the Uncheked complaint here</h2><hr />
			...
			<h5>USER NAME
				...
				<textarea type="text" name="remarks" class="form-control" style="height:200px" placeholder="Enter Remark here to complete this complaint."></textarea>
